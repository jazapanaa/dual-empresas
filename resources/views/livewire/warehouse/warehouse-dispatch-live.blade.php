<div>
    {{-- 
        SECCIÓN 1: FORMULARIO DE SALIDA
        ================================
        Formulario Livewire que permite crear nuevas salidas de productos
        o actualizar salidas existentes.
        
        Validación importante: Las salidas requieren stock disponible
        Ver: WarehouseDispatchLive::saveInventoryMovement() -> validarStockDisponible()
    --}}
    ...
    {{-- 
        ...
        ============================================
        - Botón Excel: Exporta todas las salidas a un archivo Excel
        - Botón PDF: Genera reporte PDF de salidas
    ...
    {{-- 
        ...
        ==============================
        Muestra todos los movimientos de salida filtrados por:
